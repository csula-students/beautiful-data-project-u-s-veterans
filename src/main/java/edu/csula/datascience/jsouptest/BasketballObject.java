...
public class BasketballObject {
	...
	public BasketballObject(String team, Integer year, double games_played,
			...
			double def_points_per_game, double point_difference,
			double def_field_goal_percentage, double def_three_points_percentage,
			double offensive_rebounds_percentage, double defensive_rebounds_percentage,
			double total_rebounds_percentage, double def_turnovers) {
